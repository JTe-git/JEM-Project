          ...
          <li class="jem-event jem-list-row jem-small-list row<?php echo $i % 2; ?>">
            ...
            <div class="jem-event-info-small jem-attendee-remove">
              <a href="<?php echo JRoute::_($del_link.'&cid[]='.$row->id); ?>">
                <?php echo JemOutput::removebutton(Text::_('COM_JEM_ATTENDEES_DELETE'), array('title' => Text::_('COM_JEM_ATTENDEES_DELETE'), 'class' => (version_compare(JVERSION, '3.3', 'lt')) ? 'hasTip' : 'hasTooltip')); ?>
              </a>
            </div>
          </li>
        <?php endforeach; ?>
