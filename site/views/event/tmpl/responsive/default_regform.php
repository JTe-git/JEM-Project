...
if ($this->showRegForm && empty($this->print)) :
    ...
    <input class="jem-register-button btn btn-primary" type="submit" id="jem_send_attend" name="jem_send_attend" value="<?php echo Text::_('COM_JEM_REGISTER'); ?>" disabled="disabled" /> 
