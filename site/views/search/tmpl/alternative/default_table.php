...
<div id="jem_filter" class="floattext">
	<div class="jem_fleft">
		...
		<div class="row-fluid">
			<div class="span2">
				<label for="category"><?php echo Text::_('COM_JEM_CATEGORY'); ?></label>
			</div>
			<div class="span10">
		...
		<div class="row-fluid">
			<div class="span2">
				<label for="date"><?php echo Text::_('COM_JEM_SEARCH_DATE'); ?></label>
			</div>
			<div class="span10">
				<div class="nowrap"><?php echo Text::_('COM_JEM_SEARCH_FROM') .'&nbsp;'. $this->lists['date_from'];?></div>
		...
		<div class="row-fluid">
			<div class="span2">
				<label for="continent"><?php echo ''.Text::_('COM_JEM_CONTINENT'); ?></label>
			</div>
			<div class="span10">
		...
		<div class="row-fluid">
			<div class="span2">
				<label for="country"><?php echo ''.Text::_('COM_JEM_COUNTRY'); ?></label>
			</div>
			<div class="span10">
		...
		<div class="row-fluid">
			<div class="span2">
				<label for="city"><?php echo ''.Text::_('COM_JEM_CITY');?></label>
			</div>
			<div class="span10">
		...
		<div class="row-fluid">
			<div class="offset2 span10">
				<input class="buttonfilter" type="submit" value="<?php echo Text::_('COM_JEM_SEARCH_SUBMIT'); ?>"/>
			</div>
		</div>
	</div>
...
<div class="eventtable">
	...
	<?php if (empty($this->rows)) : ?>
		<div class="row-fluid sectiontableentry<?php echo $this->params->get('pageclass_sfx'); ?>">
			<div class="span12">
				<strong><i><?php echo Text::_('COM_JEM_NO_EVENTS_FOUND'); ?></i></strong>
			</div>
		</div>
	<?php else : ?>
