...
class JFormFieldEvent extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		$html[] = '	<a class="modal" title="'.Text::_('COM_JEM_SELECT_EVENT').'"  href="'.$link.'&amp;'.JSession::getFormToken().'=1" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.Text::_('COM_JEM_SELECT_EVENT').'</a>';
		$html[] = '  </div>';
		$html[] = '</div>';
