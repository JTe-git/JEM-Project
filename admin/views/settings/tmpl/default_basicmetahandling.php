...
<!--
	...
	function include_description() {
		$("jform_meta_description").value = "<?php echo Text::_( 'COM_JEM_META_DESCRIPTION_STANDARD' ); ?>";
	}
-->
</script>
			...
			<li><label id="jform_meta_keywords-lbl" <?php echo JEMOutput::tooltip(Text::_('COM_JEM_META_KEYWORDS'), Text::_('COM_JEM_META_KEYWORDS_DESC')); ?>>
				...
				<div style="display: inline-block;">
					...
					<select name="meta_keywords[]" multiple="multiple" size="5" class="inputbox" id="jform_meta_keywords">
						...
						<?php echo Text::_( 'COM_JEM_DATE' ); ?></option>
						<option value="[times]" <?php if(in_array("[times]",$meta_key)) { echo "selected=\"selected\""; } ?>>
						<?php echo Text::_( 'COM_JEM_EVENT_TIME' ); ?></option>
						...
						<?php echo Text::_( 'COM_JEM_END_TIME' ); ?></option>
					</select>
				</div>
			</li>
