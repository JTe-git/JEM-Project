			...
			<tr>
				<td colspan="2">
					<table style="width:100%">
						<tr>
							<td>
								<strong><?php echo Text::_('COM_JEM_SEARCH'); ?></strong>
								...
								<input type="submit" value="<?php echo Text::_('JSEARCH_FILTER_SUBMIT'); ?>" class="button" />
								<input type="button" value="<?php echo Text::_('JSEARCH_FILTER_CLEAR'); ?>" class="button" onclick="f=document.adminForm;f.filter_search.value='';f.submit()" />
							</td>
