				...
				<fieldset class="adminform">
					...
					<ul class="adminformlist">
						...
						<li>
							...
							<input class="button" name="selectall" value="<?php echo Text::_('COM_JEM_EXPORT_SELECT_ALL_CATEGORIES'); ?>" onclick="selectAll();">
							<br />
							<input class="button" name="unselectall" value="<?php echo Text::_('COM_JEM_EXPORT_UNSELECT_ALL_CATEGORIES'); ?>" onclick="unselectAll();">
						</li>
						<li>
							<label></label>
